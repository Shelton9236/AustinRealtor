                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li><a href="/house/ownlist"><i class="fa fa-home"></i><span>My Realtor Info</span></a></li>
                            <li><a href="/house/bookmarked"><i class="fa fa-heart"></i><span>Realtor Collection</span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
