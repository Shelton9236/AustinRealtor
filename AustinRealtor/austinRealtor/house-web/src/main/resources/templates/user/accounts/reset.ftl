...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
             <header><h1>为${email!}Update Password</h1></header>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                    <form role="form" id="form-create-account" method="post" action="/accounts/resetSubmit" >
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="form-create-account-confirm-password">Confrim Password:</label>
                        ...
                        <div class="form-group clearfix">
                            <button type="submit" class="btn pull-right btn-default" id="account-submit">Confrim</button>
                        </div><!-- /.form-group -->
                    </form>
                    <hr>
