                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            <li><a href="/accounts/profile"><i class="fa fa-user"></i><span>Info</span></a></li>
                            <li <#if  pageType != "book">  class="active" </#if> ><a href="/house/ownlist"><i class="fa fa-home"></i><span>My Realtor</span></a></li>
                            <li <#if  pageType == "book"> class="active" </#if>><a href="/house/bookmarked"><i class="fa fa-heart"></i><span>My Collections </span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="my-properties">
                        <header><h1><#if  pageType == "book"> My Collections <#else> My Realtors</#if></h1></header>
                                ...
                                <table class="table">
                                 ...
                                 <#list ps.list as house> 
                                    <tr>
                                        ...
                                        <td><#if house.state==1>On Sale<#else>Not On Sale</#if></td>
                                        <td class="actions">
